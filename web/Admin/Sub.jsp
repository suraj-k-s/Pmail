...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">Sub Officer Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_sub_officer c inner join tbl_place p on p.place_id=c.place_id inner join tbl_district d on d.district_id=p.district_id";
                ...
                <tr>
                    <td><%=i%></td>
                    <td><%=rs.getString("sub_officer_name")%></td>
                    <td><%=rs.getString("district_name")%></td>
                    <td><%=rs.getString("place_name")%></td>
                    <td><%=rs.getString("sub_officer_contact")%></td>
                    <td><%=rs.getString("sub_officer_address")%></td>

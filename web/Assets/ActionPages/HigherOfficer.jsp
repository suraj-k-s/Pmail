    ...
    <body>
        <%
            ...
            if (isMultipart) {
                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    } else//when it is an image or multipart
                    {
                        ...
                        if (field_name.equals("file_photo"))//write the name of image here it is img_product
                        {
                            ...
                            fn = "HigherOfficer_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                ...
                String insQry = "insert into tbl_login(login_email,login_password,login_type,iv,keystring)"
                        + "values('" + value[5] + "','" + value[6] + "','HigherOfficer','"+iv+"','"+key+"')";
                ...
                if (con.executeCommand(insQry)) {
                    ...
                    if (rs.next()) {
                        ...
                        String ins = "insert into tbl_higher_officer (higher_officer_name,higher_officer_contact,higher_officer_address,district_id,grade_id,higher_officer_photo,login_id) "
                                + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[4] + "','" + fn + "','" + rs.getString("id") + "')";
        ...
        <script type="text/javascript">
            setTimeout(function() {
                ...
                window.location.href = '../../Admin/NewOfficer.jsp'

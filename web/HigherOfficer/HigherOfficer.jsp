<%-- 
    Document   : HigherOfficer
    Created on : 30 May, 2023, 3:26:23 PM
    Author     : acer
--%>
        ...
        <div class="main__body">
            ...
            <div class="emailList">
                ...
                <div class="emailList__list">
                    ...
                    <iframe style="border: none; border-radius: 15px; width: 100%; height: 653px ;" src = "HigherOfficerList.jsp" ></iframe>

    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <%                    int i = 0;
                    String selQry = "select * from tbl_sub_officer so inner join tbl_place p on p.place_id=so.place_id inner JOIN tbl_district d on d.district_id=p.district_id";

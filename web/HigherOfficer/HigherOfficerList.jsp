<%-- 
    Document   : HigherOffcerList
    Created on : 30 May, 2023, 3:26:02 PM
    Author     : acer
--%>
...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">Officer Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_higher_officer c inner join tbl_district d on d.district_id=c.district_id";
                ...
                <tr>
                    <td><%=i%></td>
                    <td><%=rs.getString("higher_officer_name")%></td>
                    <td><%=rs.getString("district_name")%></td>
                    <td><%=rs.getString("higher_officer_contact")%></td>
                    <td><%=rs.getString("higher_officer_address")%></td>
